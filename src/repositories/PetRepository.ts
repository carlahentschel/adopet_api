...
export default class PetRepository implements InterfacePetRepository {
    private petRepository: Repository<PetEntity>; //instância do repositório que será usada para realizar operações no banco de dados relacionadas aos pets
    private adotanteRepository: Repository<AdotanteEntity>; //instância do repositório que será usada para realizar operações no banco de dados relacionadas aos adotantes
